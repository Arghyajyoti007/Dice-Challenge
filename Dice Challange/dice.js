...
document.getElementsByClassName("img1")[0].setAttribute("src",'./images/dice'+ rendomnumber1 +'.png');
document.getElementsByClassName("img2")[0].setAttribute("src",'./images/dice'+ rendomnumber2 +'.png');
